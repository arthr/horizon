        ...
        <div class="container mb-5">
            <div class="d-flex align-items-center py-4 header">
                ...
                <div class="ml-auto">
                    ...
                    <button class="btn btn-muted ml-2" :class="{ active: autoLoadsNewEntries }"
                        v-on:click.prevent="autoLoadNewEntries" title="Atualizar Automaticamente">
                    ...
                    @guest
                        <router-link class="btn btn-muted ml-2" to="/login" title="Entrar">
                            Entrar
                        </router-link>
                    @endguest
                </div>
                ...
                @auth
                    <div class="ml-2">
                        <button class="btn btn-muted ml-1" v-on:click="doLogout" title="Sair">
                            Sair
                        </button>
                    </div>
                @endauth
            ...
            <div class="row mt-4">
                <div class="col-2 sidebar">
                    <ul class="nav flex-column">
                        ...
                        @auth
                            <li class="nav-item">
                                <router-link active-class="active" to="/monitoring"
                                    class="nav-link d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                            ...
                            <li class="nav-item">
                                <router-link active-class="active" to="/metrics"
                                    class="nav-link d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path
                            ...
                            <li class="nav-item">
                                <router-link active-class="active" to="/batches"
                                    class="nav-link d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                            ...
                            <li class="nav-item">
                                <router-link active-class="active" to="/jobs/pending"
                                    class="nav-link d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                            ...
                            <li class="nav-item">
                                <router-link active-class="active" to="/jobs/completed"
                                    class="nav-link d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                            ...
                            <li class="nav-item">
                                <router-link active-class="active" to="/jobs/silenced"
                                    class="nav-link d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path
                                    ...
                                    <span>Jobs Silenciados</span>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link active-class="active" to="/failed"
                                    class="nav-link d-flex align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                        ...
                        <li class="nav-item">
                            <router-link active-class="active" to="/nfe"
                                class="nav-link d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M9 3.5a5.5 5.5 0 100 11 5.5 5.5 0 000-11zM2 9a7 7 0 1112.452 4.391l3.328 3.329a.75.75 0 11-1.06 1.06l-3.329-3.328A7 7 0 012 9z"
                ...
                <div class="col-10">
                    @if (!$assetsAreCurrent)
                        <div class="alert alert-warning">
                            Os recursos do Monitore publicados não estão atualizados com a versão instalada. Para
                            atualizar, execute:<br /><code>php artisan horizon:publish</code>
                        </div>
                    @endif

                    @if ($isDownForMaintenance)
                        <div class="alert alert-warning">
                            Este aplicativo está em "modo de manutenção". Os Jobs em fila não podem ser processados, a
                            menos que seu Worker esteja usando o sinalizador "force".
                        </div>
                    @endif
