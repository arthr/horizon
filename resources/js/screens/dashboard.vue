        ...
        <div class="card overflow-hidden">
            ...
            <div class="card-bg-secondary">
                <div class="d-flex">
                    ...
                    <div class="w-25">
                        <div class="p-4">
                            <small class="text-muted font-weight-bold" v-text="recentJobsPeriod"></small>
                    ...
                    <div class="w-25">
                        <div class="p-4">
                            <small class="text-muted font-weight-bold" v-text="failedJobsPeriod"></small>
                ...
                <tbody>
                    <template v-for="queue in workload">
                        <tr>
                            ...
                            <td class="text-right text-muted" :class="{'font-weight-bold': queue.split_queues}">{{ humanTime(queue.wait) }}</td>
                        </tr>
